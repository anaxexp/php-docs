...
!!! info "IMPORTANT"
    PHP stack is not yet available for deployment via [AnaxExp](https://anaxexp.com). But you already can use it for local development with [Docker4PHP](local/index.md)
